#!/usr/bin/env bash
# Run E262 after E248, preserving a single serial eight-GPU Fire chain.
set -euo pipefail

PROJECT=/root/400083/ova_p3_tetramer_design
PREVIOUS="$PROJECT/experiments/e248_c4_fullcondition_mpnn_joint_ai_af3_seed1"
EXPERIMENT="$PROJECT/experiments/e262_c4_e243_crossbackbone_continuation_af3_seed1"
...
while [[ ! -f "$EXPERIMENT/VOLC_AF3_SHARDS_SUBMITTED" ]]; do
  "$PY" af3_pipeline/submit_af3_volc_if_capacity.py \
    --experiment "$EXPERIMENT" --job-number-start 1160
...
bash af3_pipeline/run_seed1_hits_multiseed_volc.sh \
  "$EXPERIMENT" "$PROJECT/experiments/e263_e262_top4_af3_multiseed" 1168 4
touch "$EXPERIMENT/SEED1_STRICT_SCREEN_COMPLETE"
echo "E262 adaptive cross-backbone AF3 and promoted seeds2-5 screen complete"
