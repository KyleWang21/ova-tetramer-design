#!/usr/bin/env bash
# Validate corrected E284 after E275 in the unique c20250508 eight-GPU chain.
set -euo pipefail

PROJECT=/root/400083/ova_p3_tetramer_design
PREVIOUS="$PROJECT/experiments/e275_c4_e261_softbasin_stabilization_af3_seed1"
...
echo "E284 corrected chain-mapped eight-state AF3 screen complete"
