#!/usr/bin/env bash
# Test the strongest measured dual-state tied-AF2 trajectories before E236.
set -euo pipefail

PROJECT=/root/400083/ova_p3_tetramer_design
PREVIOUS="$PROJECT/experiments/e257_c4_recovered_trajectory_ai_af3_seed1"
EXPERIMENT="$PROJECT/experiments/e259_c4_direct_tied_af2_rescue_af3_seed1"
...
while [[ ! -f "$EXPERIMENT/VOLC_AF3_SHARDS_SUBMITTED" ]]; do
  "$PY" af3_pipeline/submit_af3_volc_if_capacity.py \
    --experiment "$EXPERIMENT" --job-number-start 1128
...
bash af3_pipeline/run_seed1_hits_multiseed_volc.sh \
  "$EXPERIMENT" "$PROJECT/experiments/e260_e259_top4_af3_multiseed" 1136 4
touch "$EXPERIMENT/SEED1_STRICT_SCREEN_COMPLETE"
echo "E259 direct tied-AF2 rescue AF3 and promoted seeds2-5 screen complete"
