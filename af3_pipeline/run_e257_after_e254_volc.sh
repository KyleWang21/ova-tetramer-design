#!/usr/bin/env bash
# Validate recovered near-discrete trajectories after corrected bottom-k E287.
set -euo pipefail

PROJECT=/root/400083/ova_p3_tetramer_design
PREVIOUS="$PROJECT/experiments/e287_c4_chainmapped_bottomk_af3_seed1"
EXPERIMENT="$PROJECT/experiments/e257_c4_recovered_trajectory_ai_af3_seed1"
...
while [[ ! -f "$EXPERIMENT/VOLC_AF3_SHARDS_SUBMITTED" ]]; do
  "$PY" af3_pipeline/submit_af3_volc_if_capacity.py \
    --experiment "$EXPERIMENT" --job-number-start 1104
...
bash af3_pipeline/run_seed1_hits_multiseed_volc.sh \
  "$EXPERIMENT" "$PROJECT/experiments/e258_e257_top4_af3_multiseed" 1112 4
touch "$EXPERIMENT/SEED1_STRICT_SCREEN_COMPLETE"
echo "E257 recovered-trajectory AF3 and promoted seeds2-5 screen complete"
