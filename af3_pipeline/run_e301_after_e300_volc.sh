#!/usr/bin/env bash
# Validate E298 native-clash repairs after E299 multiseed validation.
set -euo pipefail

PROJECT=/root/400083/ova_p3_tetramer_design
PREVIOUS="$PROJECT/experiments/e300_e299_top4_af3_multiseed"
EXPERIMENT="$PROJECT/experiments/e301_c4_e298_nativeclash_repair_af3_seed1"
...
while [[ ! -f "$EXPERIMENT/VOLC_AF3_SHARDS_SUBMITTED" ]]; do
  "$PY" af3_pipeline/submit_af3_volc_if_capacity.py \
    --experiment "$EXPERIMENT" --job-number-start 1736 --priority
...
bash af3_pipeline/run_seed1_hits_multiseed_volc.sh \
  "$EXPERIMENT" "$PROJECT/experiments/e302_e301_top4_af3_multiseed" 1744 4
touch "$EXPERIMENT/SEED1_STRICT_SCREEN_COMPLETE"
echo "E301 E298 native-clash repair AF3 screen complete"
