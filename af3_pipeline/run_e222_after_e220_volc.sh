#!/usr/bin/env bash
# Submit and strictly score the AI11 AF3-Protenix cross-model Top32 after E220.
set -euo pipefail

PROJECT=/root/400083/ova_p3_tetramer_design
PREVIOUS="$PROJECT/experiments/e220_c4_073_recycle1_ai_af3_seed1"
EXPERIMENT="$PROJECT/experiments/e222_c4_ai11_crossmodel_ai_af3_seed1"
...
while [[ ! -f "$EXPERIMENT/VOLC_AF3_SHARDS_SUBMITTED" ]]; do
  "$PY" af3_pipeline/submit_af3_volc_if_capacity.py \
    --experiment "$EXPERIMENT" --job-number-start 792
...
bash af3_pipeline/run_seed1_hits_multiseed_volc.sh \
  "$EXPERIMENT" "$PROJECT/experiments/e231_e222_top4_af3_multiseed" 896 4
touch "$EXPERIMENT/SEED1_STRICT_SCREEN_COMPLETE"
echo "E222 Volc AF3 seed1 and promoted seeds2-5 screen complete"
