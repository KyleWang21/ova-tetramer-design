#!/usr/bin/env bash
# Run E248 after E244, then promote strict hits through AF3 seeds2-5.
set -euo pipefail

PROJECT=/root/400083/ova_p3_tetramer_design
PREVIOUS="$PROJECT/experiments/e244_c4_crossensemble_active_ai_af3_seed1"
EXPERIMENT="$PROJECT/experiments/e248_c4_fullcondition_mpnn_joint_ai_af3_seed1"
...
while [[ ! -f "$EXPERIMENT/VOLC_AF3_SHARDS_SUBMITTED" ]]; do
  "$PY" af3_pipeline/submit_af3_volc_if_capacity.py \
    --experiment "$EXPERIMENT" --job-number-start 1032
...
bash af3_pipeline/run_seed1_hits_multiseed_volc.sh \
  "$EXPERIMENT" "$PROJECT/experiments/e249_e248_top4_af3_multiseed" 1040 4
touch "$EXPERIMENT/SEED1_STRICT_SCREEN_COMPLETE"
echo "E248 AF3 seed1 and promoted seeds2-5 screen complete"
