#!/usr/bin/env bash
# Validate exact E283 deterministic endpoints after E284 and before E287.
set -euo pipefail

PROJECT=/root/400083/ova_p3_tetramer_design
PREVIOUS="$PROJECT/experiments/e284_c4_chainmapped_eightstate_af3_seed1"
EXPERIMENT="$PROJECT/experiments/e292_c4_e283_deterministic_final_af3_seed1"
...
while [[ ! -f "$EXPERIMENT/VOLC_AF3_SHARDS_SUBMITTED" ]]; do
  "$PY" af3_pipeline/submit_af3_volc_if_capacity.py \
    --experiment "$EXPERIMENT" --job-number-start 1632
...
bash af3_pipeline/run_seed1_hits_multiseed_volc.sh \
  "$EXPERIMENT" "$PROJECT/experiments/e293_e292_top4_af3_multiseed" 1640 4
touch "$EXPERIMENT/SEED1_STRICT_SCREEN_COMPLETE"
echo "E292 deterministic endpoint AF3 screen complete"
