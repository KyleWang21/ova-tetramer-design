#!/usr/bin/env bash
# Submit and strictly score the OVA073 Rosetta-polar Top32 after E224.
set -euo pipefail
PROJECT=/root/400083/ova_p3_tetramer_design
PREVIOUS="$PROJECT/experiments/e224_c4_ai11_crossmodel_joint_ai_af3_seed1"
EXPERIMENT="$PROJECT/experiments/e226_c4_073_rosetta_polar_ai_af3_seed1"
...
while [[ ! -f "$EXPERIMENT/VOLC_AF3_SHARDS_SUBMITTED" ]]; do
  "$PY" af3_pipeline/submit_af3_volc_if_capacity.py --experiment "$EXPERIMENT" --job-number-start 824
...
"$PY" af3_pipeline/summarize_iptm90_seed1_strict.py \
  --experiment "$EXPERIMENT" --reference-fasta OVA_P3-13R_四聚体候选_AA.fasta \
...
bash af3_pipeline/run_seed1_hits_multiseed_volc.sh \
  "$EXPERIMENT" "$PROJECT/experiments/e233_e226_top4_af3_multiseed" 928 4
touch "$EXPERIMENT/SEED1_STRICT_SCREEN_COMPLETE"
echo "E226 Volc AF3 seed1 and promoted seeds2-5 screen complete"
