#!/usr/bin/env bash
# Validate E272 after E269 in the single c20250508 eight-GPU chain.
set -euo pipefail

PROJECT=/root/400083/ova_p3_tetramer_design
PREVIOUS="$PROJECT/experiments/e269_c4_e251_softbasin_stabilization_af3_seed1"
EXPERIMENT="$PROJECT/experiments/e272_c4_multibackbone_exact_mpnn_af3_seed1"
...
while [[ ! -f "$EXPERIMENT/VOLC_AF3_SHARDS_SUBMITTED" ]]; do
  "$PY" af3_pipeline/submit_af3_volc_if_capacity.py \
    --experiment "$EXPERIMENT" --job-number-start 1264
...
bash af3_pipeline/run_seed1_hits_multiseed_volc.sh \
  "$EXPERIMENT" "$PROJECT/experiments/e273_e272_top4_af3_multiseed" 1272 4
touch "$EXPERIMENT/SEED1_STRICT_SCREEN_COMPLETE"
echo "E272 multi-backbone exact MPNN AF3 screen complete"
