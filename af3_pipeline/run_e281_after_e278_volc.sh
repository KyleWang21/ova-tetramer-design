#!/usr/bin/env bash
# Validate E281 after E278 in the unique c20250508 chain.
set -euo pipefail

PROJECT=/root/400083/ova_p3_tetramer_design
PREVIOUS="$PROJECT/experiments/e278_c4_e268_hardhit_crossbackbone_af3_seed1"
EXPERIMENT="$PROJECT/experiments/e281_c4_eightstate_multibackbone_af3_seed1"
...
while [[ ! -f "$EXPERIMENT/VOLC_AF3_SHARDS_SUBMITTED" ]]; do
  "$PY" af3_pipeline/submit_af3_volc_if_capacity.py \
    --experiment "$EXPERIMENT" --job-number-start 1360
...
bash af3_pipeline/run_seed1_hits_multiseed_volc.sh \
  "$EXPERIMENT" "$PROJECT/experiments/e282_e281_top4_af3_multiseed" 1368 4
touch "$EXPERIMENT/SEED1_STRICT_SCREEN_COMPLETE"
echo "E281 eight-state multibackbone AF3 screen complete"
