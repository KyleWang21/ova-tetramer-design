#!/usr/bin/env bash
# Run E244 after E254, then fail-fast-promote strict hits through AF3 seeds2-5.
set -euo pipefail

PROJECT=/root/400083/ova_p3_tetramer_design
PREVIOUS="$PROJECT/experiments/e254_c4_epistasis_tied_joint_ai_af3_seed1"
EXPERIMENT="$PROJECT/experiments/e244_c4_crossensemble_active_ai_af3_seed1"
...
while [[ ! -f "$EXPERIMENT/VOLC_AF3_SHARDS_SUBMITTED" ]]; do
  "$PY" af3_pipeline/submit_af3_volc_if_capacity.py \
    --experiment "$EXPERIMENT" --job-number-start 984
...
bash af3_pipeline/run_seed1_hits_multiseed_volc.sh \
  "$EXPERIMENT" "$PROJECT/experiments/e245_e244_top4_af3_multiseed" 992 4
touch "$EXPERIMENT/SEED1_STRICT_SCREEN_COMPLETE"
echo "E244 AF3 seed1 and promoted seeds2-5 screen complete"
