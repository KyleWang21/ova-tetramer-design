#!/usr/bin/env bash
# Run E307 only after the E303 strict Top20 multiseed allocation is complete.
set -euo pipefail

PROJECT=/root/400083/ova_p3_tetramer_design
PREVIOUS="$PROJECT/experiments/e303_c4_cleanbridge_allele_ai_af3_seed1"
EXPERIMENT="$PROJECT/experiments/e307_c4_e303_label_reflow_af3_seed1"
PY=/root/400083/alphafold3/repo/.venv/bin/python
cd "$PROJECT"
while [[ ! -f "$PREVIOUS/TOP20_MULTISEED_VALIDATION_COMPLETE" || \
...
while [[ ! -f "$EXPERIMENT/VOLC_AF3_SHARDS_SUBMITTED" ]]; do
  "$PY" af3_pipeline/submit_af3_volc_if_capacity.py \
    --experiment "$EXPERIMENT" --job-number-start 1848
...
bash af3_pipeline/run_seed1_hits_multiseed_volc.sh \
  "$EXPERIMENT" "$PROJECT/experiments/e308_e307_top4_af3_multiseed" 1856 4
touch "$EXPERIMENT/SEED1_STRICT_SCREEN_COMPLETE"
echo "E307 E303-label reflow AF3 screen complete"
