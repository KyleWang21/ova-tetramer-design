#!/usr/bin/env bash
# Freeze E278 AF3 candidates from the E268 hard-hit cross-backbone trajectories.
set -euo pipefail

PROJECT=/root/400083/ova_p3_tetramer_design
E277="$PROJECT/experiments/e277_c4_e268_hardhit_crossbackbone_tied_design"
E278="$PROJECT/experiments/e278_c4_e268_hardhit_crossbackbone_af3_seed1"
POOL="$E277/candidate_pool_novel"
PY=/root/400083/antibody-design/pipeline_stage6_maskcap_bindcraft/env/bin/python
cd "$PROJECT"
if [[ -f "$E278/CANDIDATES_FROZEN" ]]; then echo "E278 already frozen"; exit 0; fi
while [[ ! -f "$E277/REMOTE_ARCHIVE_RECOVERED" ]]; do sleep 30; done

"$PY" af3_pipeline/collect_iptm90_crossmodel_candidates.py \
  --experiment "$E277" --run-glob 'run_e268x_*' \
  ...
  --exclude-ignore-path "$E278/manifest.tsv" \
...
"$PY" af3_pipeline/prepare_ova_body_af3.py \
  ...
  --out "$E278" --top 32 --seeds 1 --seed-start 1 --seed-offset 0 \
  --shards 8 --n-chains 4
touch "$E278/CANDIDATES_FROZEN"
echo "E277 cross-backbone trajectories frozen as E278"
