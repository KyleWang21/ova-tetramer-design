#!/usr/bin/env bash
# Freeze E275 from stabilized E261 near-discrete trajectories.
set -euo pipefail

PROJECT=/root/400083/ova_p3_tetramer_design
E274="$PROJECT/experiments/e274_c4_e261_softbasin_stabilization_tied_design"
E275="$PROJECT/experiments/e275_c4_e261_softbasin_stabilization_af3_seed1"
POOL="$E274/candidate_pool_novel"
PY=/root/400083/antibody-design/pipeline_stage6_maskcap_bindcraft/env/bin/python
cd "$PROJECT"
if [[ -f "$E275/CANDIDATES_FROZEN" ]]; then echo "E275 already frozen"; exit 0; fi
while [[ ! -f "$E274/REMOTE_ARCHIVE_RECOVERED" ]]; do sleep 30; done
"$PY" af3_pipeline/collect_iptm90_crossmodel_candidates.py \
  --experiment "$E274" --run-glob 'run_cbsoft_*' \
  ...
  --exclude-ignore-path "$E275/manifest.tsv" \
...
"$PY" af3_pipeline/prepare_ova_body_af3.py \
  ...
  --out "$E275" --top 32 --seeds 1 --seed-start 1 --seed-offset 0 \
  --shards 8 --n-chains 4
touch "$E275/CANDIDATES_FROZEN"
echo "E274 stabilized E261 soft basin frozen as E275"
