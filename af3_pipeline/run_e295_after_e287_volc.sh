#!/usr/bin/env bash
# Validate E295 after the E284 -> E292 -> E287 priority chain.
set -euo pipefail

PROJECT=/root/400083/ova_p3_tetramer_design
PREVIOUS="$PROJECT/experiments/e287_c4_chainmapped_bottomk_af3_seed1"
EXPERIMENT="$PROJECT/experiments/e295_c4_detbest_ensemble_af3_seed1"
...
while [[ ! -f "$EXPERIMENT/VOLC_AF3_SHARDS_SUBMITTED" ]]; do
  "$PY" af3_pipeline/submit_af3_volc_if_capacity.py \
    --experiment "$EXPERIMENT" --job-number-start 1664
...
bash af3_pipeline/run_seed1_hits_multiseed_volc.sh \
  "$EXPERIMENT" "$PROJECT/experiments/e296_e295_top4_af3_multiseed" 1672 4
touch "$EXPERIMENT/SEED1_STRICT_SCREEN_COMPLETE"
echo "E295 deterministic-best ensemble AF3 screen complete"
