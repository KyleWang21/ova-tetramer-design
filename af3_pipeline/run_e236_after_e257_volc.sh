#!/usr/bin/env bash
# Prioritize the fresh cross-model active-learning batch after direct tied-AF2 rescues.
set -euo pipefail

PROJECT=/root/400083/ova_p3_tetramer_design
PREVIOUS="$PROJECT/experiments/e259_c4_direct_tied_af2_rescue_af3_seed1"
...
echo "E236 priority AF3 seed1 and promoted seeds2-5 screen complete"
