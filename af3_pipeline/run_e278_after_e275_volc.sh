#!/usr/bin/env bash
# Validate older E278 only after the E295 deterministic-best priority batch.
set -euo pipefail

PROJECT=/root/400083/ova_p3_tetramer_design
PREVIOUS="$PROJECT/experiments/e295_c4_detbest_ensemble_af3_seed1"
EXPERIMENT="$PROJECT/experiments/e278_c4_e268_hardhit_crossbackbone_af3_seed1"
...
while [[ ! -f "$EXPERIMENT/VOLC_AF3_SHARDS_SUBMITTED" ]]; do
  "$PY" af3_pipeline/submit_af3_volc_if_capacity.py \
    --experiment "$EXPERIMENT" --job-number-start 1328
...
bash af3_pipeline/run_seed1_hits_multiseed_volc.sh \
  "$EXPERIMENT" "$PROJECT/experiments/e279_e278_top4_af3_multiseed" 1336 4
touch "$EXPERIMENT/SEED1_STRICT_SCREEN_COMPLETE"
echo "E278 E268-hard-hit cross-backbone AF3 screen complete"
