#!/usr/bin/env bash
# Freeze E269 from the E251 near-discrete soft-basin stabilization trajectories.
set -euo pipefail

PROJECT=/root/400083/ova_p3_tetramer_design
E268="$PROJECT/experiments/e268_c4_e251_softbasin_stabilization_tied_design"
E269="$PROJECT/experiments/e269_c4_e251_softbasin_stabilization_af3_seed1"
POOL="$E268/candidate_pool_novel"
PY=/root/400083/antibody-design/pipeline_stage6_maskcap_bindcraft/env/bin/python
cd "$PROJECT"
if [[ -f "$E269/CANDIDATES_FROZEN" ]]; then echo "E269 already frozen"; exit 0; fi
while [[ ! -f "$E268/REMOTE_ARCHIVE_RECOVERED" ]]; do sleep 30; done
"$PY" af3_pipeline/collect_iptm90_crossmodel_candidates.py \
  --experiment "$E268" --run-glob 'run_softstab_*' \
  ...
  --exclude-ignore-path "$E269/manifest.tsv" \
...
"$PY" af3_pipeline/prepare_ova_body_af3.py \
  ...
  --out "$E269" --top 32 --seeds 1 --seed-start 1 --seed-offset 0 \
  --shards 8 --n-chains 4
touch "$E269/CANDIDATES_FROZEN"
echo "E268 soft-basin stabilization trajectories frozen as E269"
