#!/usr/bin/env bash
# Submit and strictly score the OVA073 balanced-v9 Top32 after E212.
set -euo pipefail

PROJECT=/root/400083/ova_p3_tetramer_design
PREVIOUS="$PROJECT/experiments/e212_c4_276fix_joint_ai_af3_seed1"
EXPERIMENT="$PROJECT/experiments/e216_c4_073_balanced_v9_ai_af3_seed1"
...
while [[ ! -f "$EXPERIMENT/VOLC_AF3_SHARDS_SUBMITTED" ]]; do
  "$PY" af3_pipeline/submit_af3_volc_if_capacity.py \
    --experiment "$EXPERIMENT" --job-number-start 744
...
bash af3_pipeline/run_seed1_hits_multiseed_volc.sh \
  "$EXPERIMENT" "$PROJECT/experiments/e228_e216_top4_af3_multiseed" 848 4
touch "$EXPERIMENT/SEED1_STRICT_SCREEN_COMPLETE"
echo "E216 Volc AF3 seed1 and promoted seeds2-5 screen complete"
