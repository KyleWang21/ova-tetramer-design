...
def main() -> None:
    ...
    for task_index in range(8):
        ...
        body["RuntimeConfig"]["Command"] = (
            ...
            f"run_c4_lowmut_af2_worker.sh {task_index} > "
            "/root/400083/ova_p3_tetramer_design/experiments/"
            f"e109_tied_c4_lowmut_af2/logs/volc_{task_index:02d}.log 2>&1'"
        )
    ...
    if args.submit:
        path = args.experiment / "volc_jobs.tsv"
