#!/usr/bin/env bash
# Validate E284 clash repairs after the deterministic E292 quota.
set -euo pipefail

PROJECT=/root/400083/ova_p3_tetramer_design
PREVIOUS="$PROJECT/experiments/e292_c4_e283_deterministic_final_af3_seed1"
EXPERIMENT="$PROJECT/experiments/e297_c4_e284_clashrepair_af3_seed1"
...
while [[ ! -f "$EXPERIMENT/VOLC_AF3_SHARDS_SUBMITTED" ]]; do
  "$PY" af3_pipeline/submit_af3_volc_if_capacity.py \
    --experiment "$EXPERIMENT" --job-number-start 1688
...
bash af3_pipeline/run_seed1_hits_multiseed_volc.sh \
  "$EXPERIMENT" "$PROJECT/experiments/e298_e297_top4_af3_multiseed" 1696 4
touch "$EXPERIMENT/SEED1_STRICT_SCREEN_COMPLETE"
echo "E297 E284 clash-repair AF3 screen complete"
